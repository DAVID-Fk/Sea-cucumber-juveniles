...
#svg(file="fig2.svg", width=3.5, height=7)
  ...
  par(las=1, mar=c(4,5,2,2), mfrow=c(4,1), bty="n", oma=c(0,0,1,0))
  ...
  title(main="Co-cultured with European abalones \n (Ea condition)", cex.main=0.9)
  ...
  title(main="Co-cultured underneath European flat oysters \n (Eo condition)", cex.main=0.9)
  ...
  title(main="Co-cultured underneath Pacific oysters \n (Po condition)", cex.main=0.9)
  ...
  title(main="Indoor monocultured \n (Im condition)", cex.main=0.9)
...
#pdf(file="fig5.pdf", width=5, height=7)
  ...
  boxplot(totFA~FAcond, xlab="Condition", ylab=expression(paste("Fatty acids concentration (mg g d", w^-1, ")")), ylim=c(0,17), cex.lab=0.9)
...
#pdf(file="fig8.pdf", width=7.5, height=6)
