...
```{r echo=FALSE, fig.width=7.5, fig.height=6, fig.align="center"}
  ...
  legend("topleft", legend=c("Sea ranched", "Indoor farmed", "Wild specimen"), pch=23, col="grey40", text.col="black", pt.bg=c("grey80", "grey20", "white"), bty="n", pt.cex=2, inset=c(0.02, 0.01))
